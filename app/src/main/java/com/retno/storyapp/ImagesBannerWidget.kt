...
class ImagesBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.retno.storyapp.TOAST_ACTION"
        const val EXTRA_ITEM = "com.retno.storyapp.EXTRA_ITEM"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == TOAST_ACTION) {
            ...
            Toast.makeText(context, "Touched story at position $viewIndex", Toast.LENGTH_SHORT).show()
        }
    }
}
